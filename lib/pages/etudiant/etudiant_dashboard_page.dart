...
import '../../apiservice/websocket/websocket_service.dart';
...
class _EtudiantDashboardPageState extends State<EtudiantDashboardPage> {
  ...
  Widget _buildActiveSeanceCard(Seance seance) {
    bool isMarked = seance.isPresent == true;
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
        side: BorderSide(
            color: isMarked ? Colors.green : Colors.redAccent, width: 1),
      ),
      child: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(
          ...
          children: [
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isMarked ? Colors.green.shade50 : Colors.red.shade50,
            ...
            SizedBox(
              ...
              child: ShadButton(
                onPressed: (isMarked || _isMarkingPresence)
                    ? null
                    : () => _markPresence(seance.id),
                backgroundColor: isMarked ? Colors.grey : Colors.green,
                child: _isMarkingPresence
                    ...
                    : Text(
                        isMarked ? 'Présence déjà marquée' : 'Marquer ma présence',
